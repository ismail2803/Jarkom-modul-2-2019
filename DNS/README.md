...
Client akan meminta alamat IP dari suatu domain ke DNS server. Jika pada DNS server data alamat IP dari DNS 
...
### 1.2.5 Record CNAME
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjI5OTYxMDEzLDM1MTUyMjI0NCwtMTA0Nj
